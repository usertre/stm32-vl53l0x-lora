...
void vl53l0x_general_test(VL53L0X_Dev_t *dev)
{
	...
	{	
		...
		else if(key==KEY0_PRES)//启动测量
		{
			...
			//////////////
			if(!LORA_AUX)								//若空闲///////////////////look line 226
			 {
				  Lora_mode=2;						//标记"发送状态"///////////////////look line 226
					//if(PA1==1)                              
				  LoRa_SendData();				//发送数据    ///////////////////look line 226
			  }
				delay_ms(1000);//////////////////////2020/10/22 15:15    MCUFLY-->STM32  OK   VL53L0X  OK    function  error  EVEN NOTE THEM
